package com.casestudymd4.security;

import com.casestudymd4.service.account.IServiceAccount;
import com.casestudymd4.service.account.ServiceAccount;
...
public class JwtAuthenticationTokenFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (jwtService.validateTokenLogin(authToken)) {
            ...
            com.casestudymd4.model.Account account = serviceAccount.loadUserByEmail(email);
            if (email != null) {
